...
void FAuraGameplayTags::InitializeNativeGameplauTags()
{
	//靜態函數不是任何一個實例的函數，因此沒有this指針(他不知道Attributes_Secondary_Armor是誰的)
	GameplayTags.Attributes_Secondary_Armor = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Attributes.Secondary.Armor"),FString("Armor to reduce damage, Improves Block Chance"));
	//C88
